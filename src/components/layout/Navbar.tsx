      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mt-4 flex items-center justify-between rounded-2xl border border-white/10 bg-neutral-900/50 px-4 py-3 backdrop-blur supports-[backdrop-filter]:bg-neutral-900/40">
          <div className="flex items-center gap-3">
            ...
            <span className="select-none text-sm font-semibold tracking-wide text-white">
              MyPortfolio
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              className="inline-flex items-center gap-2 rounded-md p-2 text-neutral-300 hover:text-white md:hidden"
